...
// Redes sociales del footer. Todavía no existen las cuentas: al hacer clic muestra
// un aviso de "pronto" en vez de enlazar a una página inexistente.
  ...
  return (
    <div className="footer-social">
      <div className="footer-social__icons">
        <button type="button" className="footer-social__btn" aria-label="Instagram" onClick={() => setShowMsg(true)}>
      ...
      {showMsg && (
        <p className="footer-social__msg" role="status">
          Aún no tenemos redes, ¡pero estamos trabajando en ellas! 🚧
        </p>
      )}
    </div>
  )
