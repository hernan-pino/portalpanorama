...
export class PrismaTagRepository implements TagRepository {
  ...
  // Resuelve tags por id con su capa para que el dominio valide los topes
  // (AUDIENCE ≤ 4, OCCASION ≤ 3, VIBE ≤ 3) al construir el Place. Solo lectura: el catálogo se siembra.
  ...
  // presentation los agrupe (con quién / ideal para / vibe / experiencia / servicios / específico).
